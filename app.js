...
app.use(cors({
    origin: ['http://localhost:5173', 'https://aws-0-eu-west-3.pooler.supabase.com:6543', 'https://icpf-api-production.up.railway.app', 'https://iguiskudllwluojaxepj.supabase.co/'],
    credentials: true,
}));
